...
cmd=['fslmaths ' input2 ' -kernel boxv 5 -ero ' input2 ];%WM erosion
system(cmd)
cmd=['fslmaths ' input3 ' -kernel boxv 5 -ero ' input3 ];%CSF erosion
system(cmd)
...
%Binarization
binarize_cmd=['fslmaths ' output '/CSF_prob.nii -thr 0.7 -bin ' output '/CSF_mask'];%0.5
system(binarize_cmd)
binarize_cmd=['fslmaths ' output '/Cortex_prob.nii -thr 0.7 -bin ' output '/Cortex_mask'];%0,35
system(binarize_cmd)
binarize_cmd=['fslmaths ' output '/WM_prob.nii -thr 0.7 -bin ' output '/WM_mask'];%0.5
system(binarize_cmd)

binarize_cmd=['fslmaths ' output '/gm1_prob.nii -thr 0.99 -bin ' output '/gm1_mask'];%0,7
system(binarize_cmd)
binarize_cmd=['fslmaths ' output '/gm2_prob.nii -thr 0.99 -bin ' output '/gm2_mask'];%0,7
system(binarize_cmd)
binarize_cmd=['fslmaths ' output '/gm3_prob.nii -thr 0.99 -bin ' output '/gm3_mask'];%0,7
system(binarize_cmd)
