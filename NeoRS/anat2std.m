...
cmd=['flirt -in ' input  ' -ref ' atlas1mm ' -omat ' output_1mm '.mat -out ' output_1mm ' -dof 12  -noresampblur'];
system(cmd)

% T2 to Atlas (3x3x3 mm)
cmd=['flirt -in ' output_1mm  ' -ref ' atlas3mm ' -omat ' output '.mat -out ' output ' -dof 12  -noresampblur'];
system(cmd)
